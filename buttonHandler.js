...
class ButtonHandler {
    ...
    async handleWhatsAppOrder(userSession) {
        return {
            ...
            buttons: [
                { id: 'quick_quote', text: '💰 Get Quick Quote' },
                { id: 'order_call', text: '📞 Call to Order' },
                { id: 'menu_collection', text: '👗 View Collection' }
            ],
            footer: "We'll respond with detailed quotation!",
            sessionUpdate: { 
    ...
    async handleQuickQuote(userSession) {
        return {
            ...
            buttons: [
                { id: 'order_whatsapp', text: '💬 Send WhatsApp' },
                { id: 'order_call', text: '📞 Call Now' },
                { id: 'menu_collection', text: '👗 View Products' }
            ],
            footer: "Get your quote in 30 minutes!",
            sessionUpdate: { 
    ...
    async handleJoinChannel(userSession) {
        return {
            ...
            buttons: [
                { id: 'join_group', text: '👥 Join Group Too' },
                { id: 'get_updates', text: '🔔 More Updates' },
                { id: 'back_to_menu', text: '🏠 Main Menu' }
            ],
            footer: "Stay updated with latest offers!",
            sessionUpdate: { 
    ...
    async handleCatalogRequest(userSession) {
        return {
            ...
            buttons: [
                { id: 'order_call', text: '📞 Call for Catalog' },
                { id: 'order_whatsapp', text: '💬 WhatsApp Request' },
                { id: 'menu_collection', text: '👗 Browse Online' }
            ],
            footer: "Get complete catalog in minutes!",
    ...
    async handleCallContact(userSession) {
        return {
            ...
            buttons: [
                { id: 'quick_quote', text: '💰 Get Quote First' },
                { id: 'menu_hours', text: '🕒 Business Hours' },
                { id: 'order_whatsapp', text: '💬 WhatsApp Instead' }
            ],
            footer: "We're ready to assist you!",
    ...
    async handleLocationShare(userSession) {
        return {
            ...
            buttons: [
                { id: 'contact_call', text: '📞 Call for Directions' },
                { id: 'menu_contact', text: '📱 More Contact Info' },
                { id: 'back_to_menu', text: '🏠 Main Menu' }
            ],
            footer: "Serving customers across India!",
